...
positive = scan('D:/Univ_Lille/R/positive-words.txt', what = 'character', comment.char = ';')
negative = scan('D:/Univ_Lille/R/negative-words.txt', what = 'character', comment.char = ';')
